...
load data local infile 'train.txt' into table wn18rr_train;

create table wn18rr_test (ein char(8), rel char(28), eout char(8));
load data local infile 'test.txt' into table wn18rr_test;

create table wn18rr_valid (ein char(8), rel char(28), eout char(8));
load data local infile 'valid.txt' into table wn18rr_valid;
